...
global.apikey = 'AryaXyz' // LOLHUMAN
...
//—————「 Set Nama Bot & Own 」—————//
global.namabot = 'xʏʀᴀʙᴏᴛᴢ-ᴍᴅ'
global.namaowner = 'Kii Code'
...
//—————「 Set Wm 」—————//
global.packname = 'xʏʀᴀʙᴏᴛᴢ-ᴍᴅ'
global.author = 'Bot: +62 838-7711-8785\nYouTube: BaruekGilo\nInstagram: muhmd_zaki45'
global.prefa = ['', '.']
global.sp = '•'
