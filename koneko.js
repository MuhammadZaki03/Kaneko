...
conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        title: `${ucapanWaktu} ${pushname}`,
        body: "ᴋᴏɴᴇᴋᴏ-ᴍᴅ",
        thumbnailUrl: "https://telegra.ph/file/8b0b1470e7194c9bd94c9.png",
        sourceUrl: "https://chat.whatsapp.com/HcCRmsV8l0q4gLstSQsLkA",
        mediaType: 1,
        renderLargerThumbnail: true
      }
...
let e = String(err)
conn.sendMessage("6283877118785@s.whatsapp.net", { text: "👋🏻 Hello developer, ada yang error nih! di bagian " + util.format(e), 
contextInfo:{
